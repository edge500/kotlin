...
abstract class AbstractWasmKlibDiagnosticsTestBase(
    ...
    override fun configure(builder: TestConfigurationBuilder) = with(builder) {
        globalDefaults {
            ...
            targetPlatform = this@AbstractWasmKlibDiagnosticsTestBase.targetPlatform
...
abstract class AbstractDiagnosticsFirWasmKlibTest : AbstractWasmKlibDiagnosticsTestBase(
    FirParser.Psi,
    WasmPlatforms.wasmJs,
    ::WasmEnvironmentConfiguratorJs
)

abstract class AbstractDiagnosticsFirWasmWasiKlibTest : AbstractWasmKlibDiagnosticsTestBase(
    FirParser.Psi,
