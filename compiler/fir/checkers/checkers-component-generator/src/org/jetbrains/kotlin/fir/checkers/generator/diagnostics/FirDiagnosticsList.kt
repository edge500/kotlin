...
object DIAGNOSTICS_LIST : DiagnosticList("FirErrors") {
    ...
    val PROPERTIES_AND_ACCESSORS by object : DiagnosticGroup("Properties & accessors") {
        ...
        val MUST_BE_INITIALIZED by error<PsiElement>(PositioningStrategy.CALLABLE_DECLARATION_SIGNATURE_NO_MODIFIERS)
        val MUST_BE_INITIALIZED_WARNING by warning<PsiElement>(PositioningStrategy.CALLABLE_DECLARATION_SIGNATURE_NO_MODIFIERS)
        ...
        val NON_FINAL_PROPERTY_WITH_EXPLICIT_BACKING_FIELD by error<KtBackingField>(PositioningStrategy.MODALITY_MODIFIER)
