...
object FirErrors : KtDiagnosticsContainer() {
    ...
    val MUST_BE_INITIALIZED: KtDiagnosticFactory0 = KtDiagnosticFactory0("MUST_BE_INITIALIZED", ERROR, SourceElementPositioningStrategies.CALLABLE_DECLARATION_SIGNATURE_NO_MODIFIERS, PsiElement::class, getRendererFactory())
    val MUST_BE_INITIALIZED_WARNING: KtDiagnosticFactory0 = KtDiagnosticFactory0("MUST_BE_INITIALIZED_WARNING", WARNING, SourceElementPositioningStrategies.CALLABLE_DECLARATION_SIGNATURE_NO_MODIFIERS, PsiElement::class, getRendererFactory())
    ...
    val NON_FINAL_PROPERTY_WITH_EXPLICIT_BACKING_FIELD: KtDiagnosticFactory0 = KtDiagnosticFactory0("NON_FINAL_PROPERTY_WITH_EXPLICIT_BACKING_FIELD", ERROR, SourceElementPositioningStrategies.MODALITY_MODIFIER, KtBackingField::class, getRendererFactory())
